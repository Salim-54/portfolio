      ...
      <div className="Container">
        ...
        <div className="BigCard">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
              Hello! My name is <strong>Salim Ndayisabye</strong>. I'm
              originally from Rwanda. During my time here, I gained valuable
            ...
            <ScrollAnimation animateIn="fadeInLeft">
              ...
              and Computer engineering Technology program. Despite its
              challenges, I remained determined and forged lasting friendships
              that supported me throughout this demanding program. Throughout my
              studies, I had the opportunity to engage in fascinating projects.
              Notably, I contributed to the development of the MEGGA Meds and
              NFC Library Access and Control System, projects that garnered
            ...
            <ScrollAnimation animateIn="fadeInLeft">
              ...
              mobile and desktop apps development.
